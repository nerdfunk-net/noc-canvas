...
async def get_unified_settings(
    ...
    unified.nautobot = {
        ...
        "url": app_settings.nautobot_url or "",
        "token": "***" if app_settings.nautobot_token else "",
        "verifyTls": app_settings.nautobot_verify_ssl,
    ...
    unified.checkmk = {
        ...
        "url": app_settings.checkmk_url or "",
        "site": app_settings.checkmk_site or "cmk",
        "username": app_settings.checkmk_username or "",
        "password": "***" if app_settings.checkmk_password else "",
        "verifyTls": app_settings.checkmk_verify_ssl
    }
