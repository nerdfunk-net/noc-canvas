...
def get_dynamic_setting(db: Session, key: str, default: Optional[str] = None) -> Optional[str]:
    """
...
def get_nautobot_config(db: Session) -> dict:
    ...
    return {
        ...
        "timeout": int(get_dynamic_setting(db, "nautobot_timeout", str(env_settings.nautobot_timeout))),
        "verify_ssl": get_dynamic_setting(db, "nautobot_verify_tls", str(env_settings.nautobot_verify_ssl)).lower() == "true",
    }
...
def get_checkmk_config(db: Session) -> dict:
    ...
    return {
        ...
        "username": get_dynamic_setting(db, "checkmk_username", env_settings.checkmk_username),
        "password": get_dynamic_setting(db, "checkmk_password", env_settings.checkmk_password),
        "verify_ssl": get_dynamic_setting(db, "checkmk_verify_ssl", str(env_settings.checkmk_verify_ssl)).lower() == "true",
        "timeout": int(get_dynamic_setting(db, "checkmk_timeout", str(env_settings.checkmk_timeout))),
    }
