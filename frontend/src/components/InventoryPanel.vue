<template>
  <div class="h-full flex flex-col bg-white border-r border-gray-200">
    ...
    <div v-else-if="!settingsStore.settings.nautobot.enabled && settingsStore.settings.nautobot.url" class="flex-1 flex items-center justify-center">
    ...
    <div v-else-if="!settingsStore.settings.nautobot.url" class="flex-1 flex items-center justify-center">
      <div class="text-center px-4">
        <svg class="w-8 h-8 mx-auto mb-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
